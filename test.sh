...
try 1 "int main(){return 1>=0;}"
try 1 "int main(){a=1;return a;}"
try 1 "int main(){a=1;b=a;return b;}"
try 6 "int main(){hoge=1;fuga=hoge*2;piyo=fuga*3;return piyo;}"
...
try 1 "int main(){a=0;while(a==0)return 1;return 0;}"
try 0 "int main(){a=0;while(a==1)return 1;return 0;}"
try 3 "int main(){a=0;while(a<3)a=a+1;return a;}"
try 3 "int main(){for(i=0;i<3;i=i+1)0;return i;}"
try 3 "int main(){for(i=0;i<3;)i=i+1;return i;}"
try 3 "int main(){for(i=0;;i=i+1)if(i>=3)return i;}"
try 3 "int main(){i=0;for(;i<3;i=i+1)0;return i;}"
try 0 "int main(){{a=1;b=2;c=3;return 0;}}"
try 1 "int main(){if(1==1){a=1;return a;}return 0;}"
try 6 "int main(){i=0;while(i<5){i=i+1;i=i+1;}return i;}"
try 2 "int main(){i=0;{i=1;i=2;}return i;}"
